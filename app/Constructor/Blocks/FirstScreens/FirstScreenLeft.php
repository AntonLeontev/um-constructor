...
class FirstScreenLeft extends AbstractBlock
{
    protected static string $title = 'First screen with left image';

    protected static string $view = 'constructor.blocks.FirstScreenLeft.view';

    protected static string $neuralText = 'constructor.blocks.FirstScreenLeft.neural-text';
