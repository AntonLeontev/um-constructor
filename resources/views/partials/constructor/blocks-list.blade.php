<div class="flex flex-col w-[200px] border-r p-1" x-data="siteBlocks">
	<div class="flex flex-col gap-1 overflow-auto basis-auto">
		<template x-for="block in siteBlocks">
			<div 
				class="relative p-1 transition border cursor-pointer" 
			...
			>
				...
				<button class="absolute top-1 left-1 btn btn-ghost btn-circle btn-sm" @click.stop="deleteSiteBlock(block.id)">
