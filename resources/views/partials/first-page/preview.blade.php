    ...
    <div class="border-2">
        ...
        <div class="relative flex aspect-[1200/500] items-center px-[5%]">
            <div class="relative flex flex-col justify-center w-full @container">
                ...
                <textarea class="relative z-10 mb-[3%] bg-transparent text-[60%] focus-visible:outline-none resize-none"
                    x-model="subtitle"></textarea>
                <input class="relative z-10 w-min bg-black text-center text-[70%] text-white uppercase focus-visible:outline-none" x-model="button">
